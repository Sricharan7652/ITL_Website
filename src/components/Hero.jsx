...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center overflow-hidden bg-gradient-to-r from-dark-base to-dark-blue pt-24 pb-12">
      ...
      <div className="relative z-10 w-full max-w-[1080px] mx-auto px-4 sm:px-0 flex flex-col justify-center h-full pt-32">
        {/* Tagline */}
        ...
        <div className="w-full flex justify-end mt-24 md:mt-32 pb-24">
        ...
        <div className="md:absolute md:bottom-0 md:left-0 md:right-0 w-full max-w-[1080px] mx-auto border-t-[0.5px] border-white/25 pt-[42px] pb-[42px] flex items-center justify-between">
          <span className="text-white text-sm font-serif tracking-tight">Scroll to Discover</span>
          {/* Arrow Icon 16x16 */}
          <div className="w-4 h-4 flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 12L3.5 7.5L4.55 6.45L8 9.9L11.45 6.45L12.5 7.5L8 12Z" fill="white" />
            </svg>
          </div>
        </div>
      </div>
