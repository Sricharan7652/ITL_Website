      ...
      <div className="max-w-[1080px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 md:h-32">
          ...
          <div className="flex items-center gap-3">
            <span className="text-white text-3xl font-bold italic tracking-tighter">I.T.L</span>
            <span className="h-8 w-px bg-white/20"></span>
            <span className="text-white text-sm font-light leading-tight max-w-[100px]">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {['The Institute', 'Our Approach', 'Ecosystem', 'Insights', 'Contact Us'].map((item) => (
              <a
                ...
                className={`text-sm font-medium transition-colors ${item === 'The Institute'
                    ? 'text-white border border-blue-500 px-3 py-1 rounded'
